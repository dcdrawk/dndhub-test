      ...
      <xen-card-content>
        <div class="row xen-color-primary">
          <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            @input="$bus.$emit('update_character', {key: 'background', value: $event});">
            </xen-select>
          </div>

          <div class="col-lg-12 col-md-12 col-xs-12 xen-no-margin">
            <xen-select class="xen-color-primary"
            label="Alignment"
            :options="alignments"
            option-key="name"
            :value="character.alignment"
            @input="$bus.$emit('update_character', {key: 'alignment', value: $event});">
            </xen-select>
          </div>
          ...
          <div class="col-lg-12 col-md-12 col-xs-12 xen-no-margin">
            ...
            @input="$bus.$emit('update_character', {key: 'personality', value: $event});">
            </xen-text-area>
          </div>
          ...
          <div class="col-lg-12 col-md-12 col-xs-12 xen-no-margin">
            ...
            @input="$bus.$emit('update_character', {key: 'ideals', value: $event});">
            </xen-text-area>
          </div>
          ...
          <div class="col-lg-12 col-md-12 col-xs-12 xen-no-margin">
            ...
            @input="$bus.$emit('update_character', {key: 'bonds', value: $event});">
            </xen-text-area>
          </div>
          ...
          <div class="col-lg-12 col-md-12 col-xs-12 xen-no-margin">
            ...
            @input="$bus.$emit('update_character', {key: 'flaws', value: $event});">
            </xen-text-area>
          </div>
